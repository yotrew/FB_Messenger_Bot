...
![Create a Fans Page](./imgs/1.png)  
![Create a Fans Page](./imgs/2.png)  
![Create a Fans Page](./imgs/3.png)  
  
## Step3. Go to "FB Developer" and Create a FB APPs  
[FB Developer Website](https://developers.facebook.com/)
![Create a FB APPs](./imgs/5.png)  
![Create a FB APPs](./imgs/6.png)  
![Create a FB APPs](./imgs/7.png)  
